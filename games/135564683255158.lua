...
if isfile('vain/games/'..vape.Place..'.lua') then
	loadstring(readfile('vain/games/'..vape.Place..'.lua'), 'prison life')()
else
	if not shared.VapeDeveloper then
		local success, result = pcall(downloadFile, 'vain/games/'..vape.Place..'.lua')
