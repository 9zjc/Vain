...
if not shared.VapeDeveloper then
	local _, subbed = pcall(function()
		return game:HttpGet('https://github.com/9zjc/Vain')
	end)
	...
	if (isfile('vain/profiles/asset.txt') and readfile('vain/profiles/asset.txt') or '') ~= assetVer then
		wipeFolder('vain/assets')
	end

	writefile('vain/profiles/asset.txt', assetVer)
